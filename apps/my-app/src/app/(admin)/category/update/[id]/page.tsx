...
const UpdateCategory = ({ params }: { params: { id: string } }) => {
  ...
  const { data: categoryByIdData, loading: categoryByIdLoading } = useQuery(UPDATE_CATEGORY_BY_ID, {
    ...
    onCompleted(data) {
      ...
      setCategoryDetails({
        ...
        description: updatedData.descreption,
      });
  ...
  console.log('categoryDataByID', categoryByIdData);

  const [
    UpdateCategoryByID,
    { data: updateCategoryData, loading: updateCategoryLoading, error: updateCategoryError },
